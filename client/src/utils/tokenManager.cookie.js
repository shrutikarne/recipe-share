 ...
 */
export const setAuthenticated = (userId = null) => {
...
/**
 * Calculate token expiry time from a JWT token
 * Since we don't have direct access to the token, this will be set by the login response
...
export const isTokenExpiringSoon = () => {
  ...
  // Token is expiring in the next 5 minutes
